...
class Representation(object):
  ...
  def attrs_names_to_repr(self):
    ...
    """
    return [
        attr_name for attr_name in self.attrs_names if attr_name not in [
        "custom_attribute_definitions", "custom_attribute_values"]]
    ...
    def convert_repr_rest_to_ui(obj):
      ...
      def convert_attr_val_repr_dict_to_unicode(attr_name, attr_value):
        ...
        if isinstance(attr_value, dict):
          ...
          if attr_name in [
              "contact", "manager", "owners", "assignees", "creators",
        ...
        if isinstance(obj_attr_value, dict) and obj_attr_value:
          ...
          if obj_attr_name == "modified_by":
            ...
            obj_attr_value = getattr(rest_service.ObjectsInfoService().get_obj(
                obj=Entity.repr_dict_to_obj(obj_attr_value)), "email")
  ...
  def compare_cas(self_cas, other_cas):
    ...
    if (isinstance(self_cas, (dict, type(None))) and
      ...
      return (True if (not self_cas and not other_cas)
              else StringMethods.is_subset_of_dicts(self_cas, other_cas))
    else:
...
class Entity(Representation):
  ...
  def __init__(self, type=None, slug=None, id=None, title=None, href=None,
               url=None, admins=None, primary_contacts=None,
               secondary_contacts=None, status=None, os_state=None,
               comments=None, custom_attribute_definitions=None,
               custom_attribute_values=None, custom_attributes=None,
               created_at=None, updated_at=None, modified_by=None):
    self.type = type
    self.slug = slug  # code
    self.id = id
    self.title = title
    ...
    self.comments = comments  # modified_by, created_at, description
    ...
    self.created_at = created_at  # created datetime
...
class CommentEntity(Representation):
  ...
  def __init__(self, type=None, id=None, href=None, description=None,
...
class PersonEntity(Entity):
  ...
  def __init__(self, name=None, email=None, company=None,
    ...
    self.system_wide_role = system_wide_role  # system or admin user role
...
class ControlEntity(Entity):
  ...
  def __init__(self, principal_assignees=None, secondary_assignees=None):
    super(ControlEntity, self).__init__()
    self.principal_assignees = principal_assignees
    self.secondary_assignees = secondary_assignees
...
class AuditEntity(Entity):
  ...
  def __init__(self, audit_captains=None, auditors=None, program=None):
    super(AuditEntity, self).__init__()
    self.delete_attrs(
        "admins", "primary_contacts", "secondary_contacts", "os_state",
        "comments")
    self.audit_captains = audit_captains
...
class AssessmentTemplateEntity(Entity):
  ...
  def __init__(self, assignees=None, verifiers=None, people_labels=None,
               template_object_type=None, audit=None):
    super(AssessmentTemplateEntity, self).__init__()
    self.delete_attrs(
        "admins", "primary_contacts", "secondary_contacts", "os_state",
        "comments")
    self.assignees = assignees  # default asmt assignees
    self.verifiers = verifiers  # default asmt verifiers
    self.template_object_type = template_object_type  # default asmt type
...
class AssessmentEntity(Entity):
  ...
  def __init__(self, creators=None, assignees=None, verifiers=None,
               assessment_type=None, verified=None, mapped_objects=None,
               audit=None):
