...
class PeopleFactory(EntitiesFactory):
  ...
  def __init__(self, obj_name=objects.Names.PEOPLE, obj_creator=None):
  ...
  def default_user(self):
    ...
    return PersonEntity().update_attrs(
        ...
        href=roles.DefaultSuperuser.HREF, email=roles.DefaultSuperuser.EMAIL,
...
class CustomAttributeDefinitionsFactory(PeopleFactory):
  ...
  def __init__(self):
    super(CustomAttributeDefinitionsFactory, self).__init__(
        objects.Names.CUSTOM_ATTRIBUTES, self.default_user)
  ...
  def _create_random_obj(self, is_add_rest_attrs):
    ...
    ca_obj = self.obj_inst().update_attrs(
        ...
        definition_type=unicode(objects.Utils.get_singular(
...
class ProgramsFactory(PeopleFactory):
  ...
  def __init__(self):
    super(ProgramsFactory, self).__init__(
        objects.Names.PROGRAMS, self.default_user)
...
class ControlsFactory(PeopleFactory):
  ...
  def __init__(self):
    super(ControlsFactory, self).__init__(objects.Names.CONTROLS, self.default_user)
...
class ObjectivesFactory(PeopleFactory):
  ...
  def __init__(self):
    super(ObjectivesFactory, self).__init__(
        objects.Names.OBJECTIVES, self.default_user)
...
class AuditsFactory(PeopleFactory):
  ...
  def __init__(self):
    super(AuditsFactory, self).__init__(objects.Names.AUDITS, self.default_user)
...
class AssessmentTemplatesFactory(PeopleFactory):
  ...
  def __init__(self):
    super(AssessmentTemplatesFactory, self).__init__(
        objects.Names.ASSESSMENT_TEMPLATES, self.default_user)
...
class AssessmentsFactory(PeopleFactory):
  ...
  def __init__(self):
    super(AssessmentsFactory, self).__init__(
        objects.Names.ASSESSMENTS, self.default_user)
...
class IssuesFactory(PeopleFactory):
  ...
  def __init__(self):
    super(IssuesFactory, self).__init__(objects.Names.ISSUES, self.default_user)
